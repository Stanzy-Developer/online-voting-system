...
<div class="container">
         ...
         <div class="row">
           ...
           <p class="text-center bg-primary p-2 rounded" style="padding: 7px; width: fit-content; margin: 20px auto;">Candidates From Others Universities</p>
          <p style="margin-bottom: 50px; padding: 7px;">These are approoved candidate from From Others Universities</p> 
         </div>
         <?php 
