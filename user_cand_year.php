...
<header id="nav-bar">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <a href="user_cand.php"><button style="margin-top:80px; cursor: pointer;" class="btn-special-2">ESG </button></a>
            </div>
            <div class="col-md-12">
            <a href="user_cand_2.php"><button style="margin-top:80px; cursor: pointer;" class="btn-special-2">IUC</button></a>
            </div>
            <div class="col-md-12">
            <a href="user_cand_3.php"><button style="margin-top:80px;  cursor: pointer;" class="btn-special-2">OTHERS</button></a>
            </div>
        </div>
    </div>
